...
export default function Footer() {
  return (
    ...
    >
      ...
      <Row className="mb-4">
        <Col md={{ span: 8, offset: 2 }} style={{ paddingLeft: "10" }}>
          <Row>
            ...
            <Col md={6} style={{ paddingLeft: "0" }}>
              ...
              <div className="d-flex">
                <a
                  href="https://apps.apple.com/ca/app/htr-provider/id6741950460"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="me-3"
                >
                ...
                <a
                  href="https://play.google.com/store/apps/details?id=com.htr_provider"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Image
