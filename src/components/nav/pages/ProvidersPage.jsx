              ...
              <Row className="g-0 align-items-center">
                ...
                <Col md={6} className="d-flex justify-content-start">
                  <Card.Body className="p-5" style={{ marginLeft: "10px" }}>
                    ...
                    >
                      As part of a growing community of massage and bodywork
                      professionals, you have the freedom to customize your
                      offerings.
                    </p>
                    <p
                      style={{
                        ...
                        {[
                          {
                            ...
                            description:
                              "We'll review your application and verify your identity, license, and experience.",
                          },
                          {
                            title: "Join the Team",
                            description:
                              "Once approved, you'll receive all the resources and guidance needed to thrive on our platform.",
                          },
                          {
                            title: "Begin Earning",
                            description:
                  ...
                  {[
                    {
                      ...
                      description:
                        "Earn 2 to 3 times more than the industry standard while keeping 83% of each payment. Get fast payment processing and receive 100% of your tips directly through the app.",
                    },
                    {
                      icon: <CalendarOutlined style={{ fontSize: "24px" }} />,
                      title: "Ultimate Flexibility",
                      description:
                        "Take control of your business by setting your own services. Choose when and where to accept appointments, even while traveling.",
                    },
                    {
                      icon: <BuildOutlined style={{ fontSize: "24px" }} />,
                      title: "Grow Your Business",
                      description:
                        "Gain exclusive access to a vast network of wellness clients and app features designed to help you secure more bookings and expand your business.",
                    },
                    {
                      icon: <TeamOutlined style={{ fontSize: "24px" }} />,
                      title: "Safety at the Forefront",
                      description:
                        "Our proprietary check-in/check-out system ensures your safety during appointments. Plus, our Trust & Safety team is always ready to support you.",
                    },
                    {
                      icon: <ShakeOutlined style={{ fontSize: "24px" }} />,
                      title: "Support When You Need It",
                      description:
                        "Our dedicated Provider Support team is available 365 days a year via the app, phone, text, or email—whenever you need assistance.",
                    },
                    {
                      icon: (
                        <SafetyCertificateOutlined
