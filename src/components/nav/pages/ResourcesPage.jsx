...
export default function ResourcesPage(props) {
    const resources = [
        ...
        },
        {
            ...
            url: "https://www.mayoclinic.org/healthy-lifestyle/stress-management/in-depth/massage/art-20045743"
        },
        {
            author: "WebMD",
            year: "2023",
            ...
            <Container fluid>
                <Row className="justify-content-center mb-5">
                    <Col md={8}>
                        ...
                        <ul>
                            <li>Swedish Massage - Gentle, relaxing massage using long strokes and kneading</li>
                            <li>Deep Tissue Massage - Targets deeper muscle layers to release chronic tension</li>
                            <li>Sports Massage - Helps prevent and treat injuries for athletes</li>
                            <li>Thai Massage - Combines stretching and pressure point therapy</li>
                            <li>Hot Stone Massage - Uses heated stones for deeper relaxation</li>
                        </ul>
                    </Col>
                </Row>
