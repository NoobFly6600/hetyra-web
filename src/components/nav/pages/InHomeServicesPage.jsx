                  ...
                  <Card.Body className="p-5">
                    <div style={{ fontSize: "18px", lineHeight: "1.8" }}>
                      <div className="mb-4">
                        ...
                        <p>
                          Browse and select from skilled, massage therapists
                          nearby. With providers available 24/7, you can
                          schedule your appointment at a time that works best
                          for you.
                        </p>
                      </div>
                      <div className="mb-4">
                        <h3 className="h4 mb-3">
                          2. Your Provider Comes to You
                        </h3>
                        <p>
                          A vetted, background-checked professional arrives at
                          your chosen location within the hour, fully equipped
                      ...
                      <div>
                        ...
                        <p>
                          Relax and savor your personalized session, all in the
            ...
            <Row className="g-4 justify-content-center">
              ...
              <Col md={3}>
                ...
                >
                  ...
                  <p style={{ fontSize: "16px", lineHeight: "1.6" }}>
                    Access verified independent professionals who offer a
                    premium experience tailored to your needs.
                  </p>
                </Card>
              </Col>
              ...
              <Col md={3}>
                ...
                >
                  ...
                  <p style={{ fontSize: "16px", lineHeight: "1.6" }}>
                    Skip the hassle of traveling to a spa and enjoy ultimate
                    convenience, privacy, and peace—no commuting, no waiting,
