      ...
      <section className="mb-8 mt-12 pt-8">
        ...
        <section className="mb-5">
          ...
          <p className="mb-4">
            ...
            Therefore, we advise you to review these Terms each time you access
            the Service to stay informed of any changes. These Terms were last
          ...
          <div className="alert alert-warning mb-4">
            ...
            <p className="mb-2">
              As described in Section 5(g) below, these Terms require the use of
              arbitration on an individual basis to resolve disputes, rather
              than through jury trials or class actions, and may limit the
        ...
        <section className="mb-5">
          ...
          <ol className="mb-5">
            ...
            <li>
              <a href="#responsibilities" className="text-decoration-none">
                Your Responsibilities
              </a>
            </li>
            <li>
              <a href="#medical-disclaimers" className="text-decoration-none">
                Medical-Related Disclaimers
              </a>
            </li>
            <li>
              <a href="#incident-reporting" className="text-decoration-none">
                Incident Reporting and Legal Support
              </a>
            </li>
            <li>
              <a href="#service-scope" className="text-decoration-none">
                Service Scope and Compliance
              </a>
            </li>
            <li>
              <a href="#anti-poaching" className="text-decoration-none">
                No-Poaching Agreement
              </a>
            </li>
            <li>
              <a href="#limitations-liability" className="text-decoration-none">
                Limitations of Liability
              </a>
            </li>
            <li>
              <a href="#booking" className="text-decoration-none">
                Booking Treatments and Medical Treatments
              </a>
            </li>
            <li>
              <a href="#referral-program" className="text-decoration-none">
                Referral Program
              </a>
            </li>
            <li>
              <a href="#providing-treatments" className="text-decoration-none">
                Providing Treatments
              </a>
            </li>
            <li>
              <a href="#text-messaging" className="text-decoration-none">
                Text Messaging
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#contests" className="text-decoration-none">
                Contests
              </a>
            </li>
            <li>
              <a href="#term-and-termination" className="text-decoration-none">
                Term and Termination
              </a>
            </li>
            <li>
              <a href="#intellectual-property" className="text-decoration-none">
            ...
            <li>
              <a href="#indemnification" className="text-decoration-none">
                Indemnification and Release
              </a>
            </li>
            <li>
              <a href="#warranty-disclaimer" className="text-decoration-none">
            ...
            <li>
              <a href="#third-party-disputes" className="text-decoration-none">
                Third-Party Disputes
              </a>
            </li>
            <li>
              <a href="#force-majeure" className="text-decoration-none">
                Force Majeure
              </a>
            </li>
            <li>
              <a
                href="#indemnification-release"
                className="text-decoration-none"
              >
                Indemnification and Release
              </a>
            ...
            <li>
              <a href="#additional-features" className="text-decoration-none">
            ...
            <li>
              <a href="#entire-agreement" className="text-decoration-none">
                Entire Agreement; Modification
              </a>
            </li>
            <li>
              <a href="#severability" className="text-decoration-none">
                Severability
              </a>
            </li>
            <li>
              <a href="#relationship" className="text-decoration-none">
                Relationship of the Parties
              </a>
            </li>
            <li>
              <a href="#waiver" className="text-decoration-none">
                Waiver
              </a>
            </li>
            <li>
              <a href="#assignment" className="text-decoration-none">
                Assignment
              </a>
            </li>
            <li>
              <a
                href="#third-party-beneficiaries"
                className="text-decoration-none"
              >
          ...
          <a href="#apple-notice" className="text-decoration-none">
        ...
        <section id="use-of-service" className="mb-5">
          ...
          <p className="mb-4">
            ...
            and wellness professionals ("Providers") with consumers,
            facilitating the delivery of Treatments (each referred to as a
          ...
          <p className="mb-4">
            Please note that the Services, including Telehealth Services, are
          ...
          <p className="mb-4">
            ...
            <ul>
              ...
              <li>
                (ii) modify or discontinue providing the Service (or any part
        ...
        <section id="registration" className="mb-5">
          ...
          <p className="mb-4">d. Eligibility</p>
          ...
          <p className="mb-4 ps-4">
            Treatments may be booked for minors by a parent or legal guardian,
            who must be present in the same room during the entire appointment.
            Guardians booking for minors must indicate they are booking for a
            dependent and provide the minor's age at the time of booking. For
            massage therapy, physical therapy, and assisted stretching
            appointments, minors must wear T-shirts and shorts throughout the
            appointment.
          </p>
          ...
          <p className="mb-4 ps-4">
            ii. If you are using the Service on behalf of a Guest (an
            individual, company, entity, or organization), you represent and
            warrant that:
            <ul className="mt-2">
              <li>
                (A) You are an authorized representative of the Guest with the
                authority to bind the Guest to these Terms.
              </li>
              <li>
                (B) You agree to be bound by these Terms on behalf of the Guest.
              </li>
              <li>
                (C) Your Guest meets the eligibility requirements for the
                Service as outlined in these Terms.
              </li>
            </ul>
            You will also be responsible for ensuring that your Guest complies
            with these Terms.
          </p>
        ...
        <section id="responsibilities" className="mb-5">
          ...
          <p className="mb-3">
            You are permitted to use the Service only for lawful, non-commercial
            purposes (unless you are a Provider or Concierge Member), in
            accordance with the intended functionality of the Service. By using
            the Service, you agree not to (and not to permit or assist any third
            party in) doing the following:
          </p>

          <ul className="mb-4">
            <li className="mb-2">
              a. Use, copy, install, transfer, or distribute the Service except
              as explicitly authorized by these Terms;
            </li>
            <li className="mb-2">
              b. Modify, adapt, translate, reverse engineer, decompile, or
              disassemble any part of the Service or its content;
            </li>
            <li className="mb-2">
              c. Remove or alter any copyright, trademark, or proprietary rights
              notices contained within the Service;
            </li>
            <li className="mb-2">
              d. Create user accounts using automated processes or under false
              or fraudulent pretenses;
            </li>
            <li className="mb-2">
              e. Use any robots, spiders, scrapers, search tools, or other
              automated means to access, retrieve, or index any part of the
              Service;
            </li>
            <li className="mb-2">
              f. Probe, scan, or test the vulnerability of any system or network
              or breach any security or authentication measures;
            </li>
            <li className="mb-2">
              g. Reformat, mirror, or frame any part of the Service's web pages;
            </li>
            <li className="mb-2">
              h. Imply or state that any of your statements are endorsed by us,
              without prior written consent;
            </li>
            <li className="mb-2">
              i. Transmit any content that is unlawful, fraudulent, abusive,
              libelous, defamatory, obscene, or otherwise harmful;
            </li>
            <li className="mb-2">
              j. Transmit any harmful software or materials, including viruses,
              worms, Trojan horses, or other malicious components;
            </li>
            <li className="mb-2">
              k. Harvest or collect personal information about other users
              without their consent;
            </li>
            <li className="mb-2">
              l. Engage in or authorize any reverse engineering, disassembly, or
              hacking of the Service;
            </li>
            <li className="mb-2">
            ...
            <li className="mb-2">
              ...
              allowed through the Service's features;
            </li>
            <li className="mb-2">
              q. Restrict, discourage, or inhibit anyone from using the Service;
            </li>
            <li className="mb-2">
              r. Gain unauthorized access to the Service, other users' accounts,
              or linked websites;
            </li>
            <li className="mb-2">
              s. Violate any applicable laws, regulations, or these Terms;
            </li>
            <li className="mb-2">
              t. Use the Service for illegal, inappropriate, or unauthorized
              conduct;
            </li>
            <li className="mb-2">
          ...
          <p className="mb-4">
            We reserve the right to take legal action and implement technical
            measures to prevent violations of these Terms and enforce
            compliance.
          </p>
        </section>
        ...
        <section id="medical-disclaimers" className="mb-5">
          ...
          <p className="mb-4">
            a. The claims made in connection with the mobile application or
            through the service have not been evaluated by the Food and Drug
            Administration and are not intended to diagnose, treat, cure, or
            prevent any disease or medical condition.
          </p>

          <p className="mb-4">
            b. The content and information made available through the service,
            including materials (collectively, the "Content"), are provided for
            informational purposes only. None of the content available through
            the service should be construed as professional medical advice or
            consultation. The content is not intended to be a substitute for
            professional medical advice, diagnosis, or treatment. By using the
            service, you agree that you will not rely on the service as a
            substitute for professional medical advice and that you will always
            seek the advice of your physician or other qualified health provider
            with any questions you may have regarding medical matters. In no
            event will a medical professional/patient relationship be created by
            using the service.
          </p>
          ...
          <p className="mb-4">
            e. You acknowledge that your reliance on any information provided by
            the service or by any provider to you is solely at your own risk,
            and you assume full responsibility for all risk associated
            therewith, as allowable to the extent of the law. The service is not
            for medical emergencies. If you think you have an emergency, call
            911 immediately.
          </p>
          ...
          <p className="mb-4">
            ...
            in all actions and interactions with any third party you interact
            with in or through the service.
          </p>

          <p className="mb-4">
            h. You agree that treatment and medical treatment appointments may
            carry inherent risks, and by requesting a treatment or medical
            treatment, you choose to assume those risks voluntarily. For
            example, the treatments and medical treatments may carry the risk of
            illness, bodily injury, disability, or death, and you freely and
            willfully assume those risks by requesting such treatments or
            medical treatments. You assume full responsibility for the choices
        ...
        <section id="service-scope" className="mb-5">
          ...
          <p className="mb-4">
            Providers are strictly limited to offering the services they have
            listed on the platform. All services must be lawful and accurately
            represented. Any attempt to provide unlisted or unauthorized
            services—whether during or outside of a booked session—without
            explicit agreement from the client is a violation. For example, if a
            provider offers additional services outside the scope of a scheduled
            60-minute relaxation massage, this constitutes a breach of policy.
            Such actions may result in an immediate account ban or financial
            penalties.
          </p>
        </section>
        ...
        <section id="booking" className="mb-5">
          <h2 className="h4 mb-3">
            9. Booking Treatments and Medical Treatments
          </h2>
          ...
          <p className="mb-4">
            ...
            have edema due to chronic heart failure or kidney failure; have an
          ...
          <p className="mb-4">
            ...
            appointment. The fee you are ultimately charged is the "Fee."
          </p>
          ...
          <p className="mb-4">
            ...
            services that are booked through the Service.
          </p>
          ...
          <p className="mb-4">
            ...
            insurance plan, whether government-sponsored or private.
          ...
          <p className="mb-4">
            i. No Conflicts
            <br />
            By accessing and/or using the Service as a Concierge Member, you
            hereby represent, warrant, and covenant to us that such access
            and/or use of the Service does not and will not violate any contract
            or agreement between you and any third party, including, without
            limitation, your employer.
          </p>
          ...
          <p className="mb-4">
            ...
            Service and any other relevant information that would be necessary
            and/or helpful to enable the Provider to provide the Treatment,
            which includes, without limitation, the Treatment recipient's name
            and address, any parking instructions, and whether the Provider must
            supply a massage table, or any other equipment.
          </p>
        ...
        <section id="referral-program" className="mb-5">
          ...
          <p className="mb-4">
            ...
            your social network, as long as you are the primary content owner of
            such a network. Both you and each friend or family member who signs
            up with your Code and completes a Treatment will receive the credit
            set forth on the Service ("Credit"); provided that you may not
            accrue more than $500 in Credit at any given time. The expiration
            date for Credits will be stated on the Service. Codes are not
            intended for distribution on public sites, such as Yelp or Facebook,
            coupon code websites, such as RetailMeNot, or via search engines. We
            reserve the right to disable your Code at our sole discretion.
            Codes:
          </p>
        ...
        <section id="electronic-communications" className="mb-5">
          ...
          <p className="mb-4">
            ...
            <br />
            By using the Service or providing Personal Information (as defined
            in the Privacy Policy) such as your email or phone number to us, you
            agree that we may communicate with you electronically to receive
            transactional communications relating to the Service and/or
            regarding security, privacy, and administrative issues relating to
            your use of the Service (i.e., update on the status of arrival,
            timing, and to confirm appointments). If we learn of a security
            system's breach, we may attempt to notify you electronically by
            posting a notice on the Service or sending an email to you, if we
          ...
          <p className="mb-4">
            ...
            only. While Messages and Notifications are intended to enhance your
            use of the Service, you may (i) disable push notifications on your
            device, and/or (ii) remove yourself from our text message database.
            You recognize and acknowledge that SMS messaging is an inherently
            less secure method of communication and agree to receive text
            messages regardless of the level of security associated with them.
          ...
          <p className="mb-4">
            ...
            <br />
            If you wish to remove yourself from any list (other than as set
            forth in Section 7.b), please email us with an "OPT-OUT",
            "UNSUBSCRIBE", "STOP", or "REMOVE" in the subject line.
          </p>
          ...
          <p className="mb-4">
            ...
            unsubscribe you from the service that most recently sent you a
            message or respond to your "STOP" message by texting you a request
            to identify the Service(s) that you wish to stop. Keep in mind that
            if you stop receiving marketing or transactional text messages from
            us, you may not receive important and helpful information and
            reminders.
          </p>
        </section>
        ...
        <section id="content-submission" className="mb-5">
          ...
          <p className="mb-4">
            ...
            associated with your profile on the Service) will be as set forth in
            ...
            reliability, or completeness of any opinion, advice, information, or
            statement available on the Service.
          </p>
          ...
          <p className="mb-4">
            ...
            <br />
            You are solely responsible for your Materials and the consequences
            of posting them on the Service. By posting Materials, you represent,
            warrant, and covenant that:
            <ul className="mt-2">
              <li>
                (i) you are the creator and owner of the Materials or otherwise
                have sufficient rights and authority to grant the rights granted
                herein;
              </li>
              <li>
                (ii) your Materials do not and will not:
                <ul>
                  <li>
                    (A) infringe, violate, or misappropriate any third-party
                    right, including any copyright, trademark, patent, trade
                    secret, moral right, privacy right, right of publicity, or
                    any other intellectual property or proprietary right, or
                  </li>
                  <li>(B) slander, defame, or libel any other person;</li>
                </ul>
              </li>
              <li>
                (iii) your Materials do not contain any viruses, adware,
                spyware, worms, or other harmful or malicious code, or
              </li>
              <li>
                (iv) unless you have received prior written authorization, your
                Materials specifically do not contain any confidential
                information of any third party.
              </li>
            </ul>
            We reserve all rights and remedies against any users who breach
        ...
        <section id="contests" className="mb-5">
          ...
          <p className="mb-4">
            ...
            any of our contests or games, you agree to be subject to those
            rules, regulations, and procedures as well as the terms and
            conditions of these Terms. In the event of a conflict between any
            Contest Rules and these Terms, the applicable Contest Rules will
            govern.
          </p>
        </section>
        ...
        <section id="ownership" className="mb-5">
          ...
          <p className="mb-4">
            ...
            <ul className="mt-2">
              <li>
                (i) the Service, including, without limitation, any Content,
              ...
              <li>
                ...
                to you pursuant to these Terms; and
              </li>
              <li>
                (iv) you have no rights in the Proprietary Information, other
                than the rights and licenses specifically granted to you
        ...
        <section id="indemnification" className="mb-5">
          ...
          <p className="mb-4">
            c. We reserve the right, at our own expense, to assume exclusive
            defense and control over any matter that would otherwise be subject
            to indemnification by you. In such cases, you agree to cooperate
            with our defense of the claim. You may not settle any claim or
        ...
        <section id="warranty-disclaimer" className="mb-5">
          ...
          <p className="mb-4">
            ...
            damages, or may impose additional rights. If these laws apply to
            you, some or all of the exclusions or limitations outlined below may
          ...
          <p className="mb-4">
            ...
            or usefulness regarding the products or services. We do not
            guarantee: (1) that the Services will meet your requirements; (2)
            that the information, content, or data on the Services is accurate;
            (3) that your use of the Services will be uninterrupted, timely,
            secure, or error-free; or (4) that any errors in the Services will
            be corrected.
          </p>
          ...
          <p className="mb-4">
            ...
            Services. We are not liable for any damages or harm related to the
            foregoing.
          </p>
          ...
          <p className="mb-4">
            You also acknowledge that the Service was not developed to meet your
            specific requirements, and it is your responsibility to ensure that
          ...
          <p className="mb-4">
            Certain local laws may not permit limitations on implied warranties.
            If these laws apply to you, some or all of the disclaimers outlined
            here may not apply, and you may have additional rights.
          </p>
        </section>
        ...
        <section id="limitation-of-liability" className="mb-5">
          ...
          <p className="mb-4">
            ...
            to or alteration of your data or transmissions; (4) statements or
            actions of any third party, including healthcare providers,
        ...
        <section id="indemnification-release" className="mb-5">
          ...
          <p className="mb-4">
            ...
            in any way connected with the Service.
          </p>

          <p className="mb-4">
            c. We reserve the right, at our expense, to assume exclusive control
            and defense of any matter that would otherwise be subject to your
            indemnification obligations. In such cases, you agree to cooperate
            with our defense of the claim. You may not settle any claim or
            matter without our prior written consent.
          </p>
        </section>
        ...
        <section id="additional-features" className="mb-5">
          ...
          <p className="mb-4">
            The Service may include information about products and services
        ...
        <section id="dispute-resolution" className="mb-5">
          ...
          <p className="mb-4">
            ...
            COURT) AS THE EXCLUSIVE FORM OF DISPUTE RESOLUTION, UNLESS OTHERWISE
            STATED BELOW, FOR ALL DISPUTES AND CLAIMS ARISING OUT OF OR RELATING
            TO THESE TERMS OR YOUR USE OF THE SERVICE. Arbitration involves a
          ...
          <p className="mb-4">
            ...
            no personal appearance will be required unless mutually agreed in
            writing; and (C) any judgment from the arbitrator may be entered in
          ...
          <p className="mb-4">
            ...
            A REPRESENTATIVE OR CLASS PROCEEDING, AND IF THIS IS FOUND TO BE
            UNENFORCEABLE, THE ENTIRE MANDATORY ARBITRATION SECTION WILL BE
            VOID.
          </p>
          ...
          <p className="mb-4">
            ...
            <br />
            The arbitrator will issue a decision within 120 days from the date
            of appointment, unless extended by 30 days in the interest of
            justice. Arbitration proceedings will be confidential, and records
            will be sealed, except as necessary to confirm the award in court.
          ...
          <p className="mb-4">
            c. Claims
            <br />
            Any cause of action related to these Terms or the Service, excluding
            indemnification claims, must be initiated within one year after the
            claim arises. Claims not filed within one year are permanently
            barred.
          </p>
          ...
          <p className="mb-4">
            f. Enforceability
            <br />
            If Section 19.a.iii or the entire Section 19 is found unenforceable,
            the exclusive jurisdiction and venue described in Section 20 will
            apply.
          </p>
        </section>
        ...
        <section id="feedback" className="mb-5">
          ...
          <p className="mb-4">
            While our team continually works on developing and assessing our own
            product ideas and features, we value and carefully consider the
            interests, feedback, comments, and suggestions provided by our
            users. If you send us, or our employees, any ideas or suggestions
            for products, services, features, modifications, enhancements,
            content, promotions, strategies, product/feature names, or any
            related materials (collectively referred to as "Feedback"), the
            following terms will apply, regardless of the content of your
            communication, to avoid any future misunderstandings. By providing
            Feedback, you agree to the following:
          </p>
        ...
        <section id="severability" className="mb-5">
          ...
          <p className="mb-4">
            ...
            unenforceable, that provision will be amended or, if modification is
            not possible, severed, in order to reflect the intent of the parties
            as closely as possible in a valid, legal, and enforceable manner.
            The rest of these Terms will remain unaffected.
          </p>
        </section>
        ...
        <section id="waiver" className="mb-5">
          ...
          <p className="mb-4">
            No delay, omission, or failure to exercise any right or remedy under
            these Terms will be considered a waiver of that right or remedy, nor
            an acceptance of the circumstances that gave rise to it. Every right
            or remedy may be exercised at any time as deemed appropriate by the
            party exercising it.
          </p>
        </section>
        ...
        <section id="apple-notice" className="mb-5">
          ...
          <p className="mb-4">
            ...
            the Service to meet applicable warranties, you may notify Apple, and
            Apple will refund the purchase price for the relevant Service.
            However, to the maximum extent permitted by law, Apple has no
            further warranty obligation regarding the Service.
          </p>

          <p className="mb-4">
            Apple is not liable for addressing any claims made by you or any
            third party related to the Service, including but not limited to:
          </p>

          <ol className="mb-4">
            <li>Product liability claims.</li>
            <li>
              Claims that the Service fails to meet applicable legal or
          ...
          <p className="mb-4">
            Apple is also not responsible for investigating, defending,
            settling, or discharging any third-party claim regarding the Service
            or your use of the Service, including intellectual property
            infringement claims.
          </p>

          <p className="mb-4">
            You agree to comply with any applicable third-party terms when using
            the Service. Apple, along with its subsidiaries, is a third-party
            beneficiary of these Terms. Upon your acceptance of these Terms,
            Apple will have the right to enforce these Terms against you as a
          ...
          <ol className="mb-4">
            <li>
              You are not located in a country subject to a Canada Government
              embargo, or one designated by the Canada Government as a
              "terrorist-supporting" country.
            </li>
            <li>
              You are not listed on any Canada Government list of prohibited or
              restricted parties.
            </li>
          </ol>
